...
export const DETAIL_INPUT = document.getElementById('detail');
export const DEADLINE_INPUT = (document.getElementById('deadline'));
...
export const MESSAGE = 'У вас пока нет дел.';
